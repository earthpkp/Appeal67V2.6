        ...
        <div class="container ">
          <div class="navcon shadow-up-">
            <q-toolbar>
              ...
              <q-btn :ripple="false" color="transparent" no-caps flat to="/Employee/Dashbord">
              ...
              <q-item clickable v-ripple :to="{ path: '/Employee/CheckStatusAppeal' }" v-if="$q.screen.width > 685"
                :class="{ 'q-item--active': $route.fullPath.startsWith('/Employee/CheckStatusAppeal/') }">
                <q-item-section>ตรวจสอบเรื่อง</q-item-section>
              </q-item>


              <q-item clickable v-ripple to="/Employee/Dashbord" v-if="$q.screen.width > 685">
              ...
              <q-btn-dropdown v-if="$q.screen.width <= 685" flat round dense icon="account_circle"
                ...
                <q-list>
                  ...
                  <q-item clickable v-ripple to="/Employee/CheckStatusAppeal">
                    <q-item-section avatar>
                      <q-icon name="star" />
                    </q-item-section>
                  ...
                  <q-item clickable v-ripple to="/Employee/Dashbord">
                    <q-item-section avatar>
                      <q-icon name="campaign" />
                    </q-item-section>
                    <q-item-section style="margin-left: -10px"> หน้าหลัก </q-item-section>
                  </q-item>
